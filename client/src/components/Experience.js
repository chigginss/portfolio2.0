...
export default function Experience() {
  ...
  return (
    <div id='experience' className={`experience fade-in-section ${isVisible ? 'is-visible' : ''}`} ref={domRef}>
      ...
      <p className='aboutMeText'> I primarily work with JavaScript (React and React Native), Typescript, and MongoDB. I've worn many hats throughout the years, but I primarily focus on delivering accessible, intuitive user facing features and experiences. </p>
